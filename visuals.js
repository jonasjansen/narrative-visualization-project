...
async function init()   {
    ...
    // get the data
    const data = await d3.csv("https://raw.githubusercontent.com/holtzy/data_to_viz/master/Example_dataset/1_OneNum.csv")
...
init().then(r => console.log("Finished creating visual."));
